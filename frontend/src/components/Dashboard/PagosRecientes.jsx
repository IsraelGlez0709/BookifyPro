  ...
  useEffect(() => {
    ...
    async function load() {
      ...
      try {
        ...
        const url = `https://oral-susan-utt-eab6c28f.koyeb.app/api/payments/recent?business_id=${negocio.id}&limit=6`;
      ...
      {loading ? (
        ...
        <Lista>
          {items.slice(0, 6).map((p) => {
            ...
            const photo = p.customer_photo ? `https://oral-susan-utt-eab6c28f.koyeb.app/${p.customer_photo}` : null;
            return (
              <Pago key={p.id}>
