...
export default function Auth() {
  ...
  const submitLogin = async (e) => {
    e.preventDefault();
    try {
      const res = await fetch("https://oral-susan-utt-eab6c28f.koyeb.app/api/users/login", {
        method: "POST",
  ...
  const submitReg = async (e) => {
    ...
    try {
      const res = await fetch("https://oral-susan-utt-eab6c28f.koyeb.app/api/users/register", {
        method: "POST",
        body: formData,
      });
