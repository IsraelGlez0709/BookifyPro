...
export default function BusinessRegister() {
  ...
  const isStepValid = () => {
    switch (step) {
      ...
      case 2:
        return specialists.every((s) => s.name && s.role && s.photo);
      case 3:
        if (!addPackages) return true;
        return packages.every((p) => p.name && p.desc && p.price);
      case 4:
        return gallery.length > 0 && gallery.every((g) => g.file);
      case 5:
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!res.ok) throw new Error(await res.text() || "Error al registrar negocio");
      await res.json();
                      ...
                      <ItemRow>
                        <InputWrapper>
                          ...
                          <input
                            ...
                            value={svc.name}
                            onChange={(e) =>
                              updateItem(services, setServices, i, "name", e.target.value)
                            }
                            required
                          />
                        </InputWrapper>
                        <InputWrapper>
                          ...
                          <input
                            ...
                            value={svc.price}
                            onChange={(e) =>
                              updateItem(services, setServices, i, "price", e.target.value)
                            }
                            required
                          />
                        </InputWrapper>
                        {services.length > 1 && (
                          <RemoveBtn
                            onClick={() => removeItem(services, setServices, i)}
                          >
                            <IoRemoveCircleOutline />
                          </RemoveBtn>
                        )}
                      ...
                      <ItemRow>
                        <InputWrapper>
                          ...
                          <input
                            ...
                            value={sp.name}
                            onChange={(e) =>
                              updateItem(specialists, setSpecialists, i, "name", e.target.value)
                            }
                            required
                          />
                        </InputWrapper>
                        <InputWrapper>
                          ...
                          <input
                            ...
                            value={sp.role}
                            onChange={(e) =>
                              updateItem(specialists, setSpecialists, i, "role", e.target.value)
                            }
                            required
                          />
                        </InputWrapper>
                        {specialists.length > 1 && (
                          <RemoveBtn
                            onClick={() => removeItem(specialists, setSpecialists, i)}
                          >
                            <IoRemoveCircleOutline />
                          </RemoveBtn>
                        )}
                        ...
                        {!sp.url ? (
                          <>
                            ...
                            <input
                              ...
                              style={{ display: "none" }}
                              onChange={(e) =>
                                handlePhoto(specialists, setSpecialists, i, e.target.files[0], "photo")
                              }
                              required
                            />
                          </>
                          ...
                          <PhotoWrapper>
                            ...
                            <RemovePhotoBtn
                              onClick={() => updateItem(specialists, setSpecialists, i, "url", "")}
                            >
                              <IoRemoveCircleOutline />
                            </RemovePhotoBtn>
                          </PhotoWrapper>
                        ...
                        <DynamicList key={i}>
                          <ItemRow>
                            <InputWrapper>
                              ...
                              <input
                                ...
                                value={pkg.name}
                                onChange={(e) =>
                                  updateItem(packages, setPackages, i, "name", e.target.value)
                                }
                                required
                              />
                            </InputWrapper>
                            {packages.length > 1 && (
                              <RemoveBtn
                                onClick={() => removeItem(packages, setPackages, i)}
                              >
                                <IoRemoveCircleOutline />
                              </RemoveBtn>
                            )}
                          ...
                          <Label>
                            ...
                            <textarea
                              value={pkg.desc}
                              onChange={(e) =>
                                updateItem(packages, setPackages, i, "desc", e.target.value)
                              }
                              required
                            />
                          </Label>
                          <ItemRow>
                            <InputWrapper>
                              ...
                              <input
                                ...
                                value={pkg.price}
                                onChange={(e) =>
                                  updateItem(packages, setPackages, i, "price", e.target.value)
                                }
                                required
                              />
                            </InputWrapper>
                            {!pkg.url ? (
                              <>
                                ...
                                <input
                                  ...
                                  style={{ display: "none" }}
                                  onChange={(e) =>
                                    handlePhoto(packages, setPackages, i, e.target.files[0], "photo")
                                  }
                                />
                              </>
                            ) : (
                              <PhotoWrapper>
                                <ImagePreview src={pkg.url} alt="vista previa" />
                                <RemovePhotoBtn
                                  onClick={() => updateItem(packages, setPackages, i, "url", "")}
                                >
                                  <IoRemoveCircleOutline />
                                </RemovePhotoBtn>
                              </PhotoWrapper>
              ...
              {step === 4 && (
                <>
                        ...
                        {!g.url ? (
                          <>
                            ...
                            <input
                              ...
                              style={{ display: "none" }}
                              onChange={(e) =>
                                handlePhoto(gallery, setGallery, i, e.target.files[0], "file")
                              }
                              required
                            />
                          </>
                  ...
                  <Button
                    ...
                    type="button"
                    onClick={() =>
                      addItem(gallery, setGallery, {
                        file: null,
                        url: "",
                      })
                    }
                  >
                    <IoAddCircleOutline /> Agregar foto
                  </Button>
                </>
              )}
              {step === 5 && (
